...
2. For creation of the panoptic model for **segmentation of cristae (STEP 2)** with recognizing **12 morphological classes**. For this traning we used another plugin [*Train a model*](https://empanada.readthedocs.io/en/latest/tutorials/train_panop.html#training-the-model). 
